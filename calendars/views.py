...
#     else:
#         form = EventForm()
#     return render(request, 'calendar/event_form.html', {'form': form, 'title': 'Create Event'})
...
#     return render(request, 'calendar/event_form.html', {'form': form, 'event': event, 'title': 'Edit Event'})
...
#     else:
#         form = ReminderForm()
#     return render(request, 'calendar/reminder_form.html', {'form': form, 'event': event})
...
#     reminder.delete()
#     return redirect('calendar:event_detail', pk=event_pk)
...
#     return render(request, 'calendar/appointment_list.html', context)
...
#             appointment.save()
#             return redirect('calendar:appointment_detail', pk=appointment.pk)
#     else:
#         form = AppointmentForm()
#     return render(request, 'calendar/appointment_form.html', {'form': form, 'title': 'Create Appointment'})
...
#     return render(request, 'calendar/appointment_form.html', {'form': form, 'appointment': appointment, 'title': 'Edit Appointment'})
...
#     appointment = get_object_or_404(Appointment, pk=pk, user=request.user)
#     appointment.delete()
#     return redirect('calendar:appointment_list')


# @login_required(login_url='admin:login')
# def dashboard(request):
#     """Dashboard showing upcoming events and appointments"""
#     today = timezone.now()
...
#         'today': today,
#     }
#     return render(request, 'calendar/dashboard.html', context)
